...
{
    public class AcceptDeleteProductsIntoFridgeByIdValidator : IValidator<AcceptDeleteProductIntoFridgeByIdDtoBL>
    {
        private readonly IDbContext context;
        private readonly IProductQueries queries;

        public AcceptDeleteProductsIntoFridgeByIdValidator(IDbContext context, IProductQueries queries)
        {
            this.context = context;
            this.queries = queries;
        }
        public async Task<object> Validate(AcceptDeleteProductIntoFridgeByIdDtoBL dto)
        {
